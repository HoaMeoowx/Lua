local MeoNotify = function(Text_i,Duration_i)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Đang Tải..",
        Text = Text_i,
        Duration = Duration_i,
        Icon = "rbxassetid://112810217944262"
    })
end
...
--Key
wait(0.1)
AlchemyNotify("Thanks for using Turbo Lite",5)
wait(0.1)
AlchemyNotify("discord.gg/dUdzZskBCC",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>Turbo Lite V2<Color=/>"):Display()
wait(0.5)
Notification.new("<Color=Yellow>Create By Turbo Lite<Color=/>"):Display()
wait(1)
repeat
    wait()
...
HomePage:Label("Discord Turbo Lite Và Các Bạn")
HomePage:Button("Copy Link", function()
    AlchemyNotify("Đã Copy Link!",5)
