...
--main
local ui_link = "https://raw.githubusercontent.com/HoaMeoowx/Lua/refs/heads/main/Avatar.lua"
local a = loadstring(game:HttpGet(ui_link))()
local a = a:Window("Free Version | Blox Fruit")
local HomePage = a:Tab("Trang Chủ", "rbxassetid://96951468820217")
local Main = a:Tab("Main Farm", "rbxassetid://15712703260")
local Farm = a:Tab("Vật Phẩm", "rbxassetid://15712717270")
local Stats = a:Tab("Chỉ Số", "rbxassetid://76287763774607")
local Shop = a:Tab("Cửa Hàng", "rbxassetid://15712767144")
local Race = a:Tab("Tộc V4", "rbxassetid://15712776421")
local Event = a:Tab("Sea Biển", "rbxassetid://115811927012077")
local Tele = a:Tab("Qua Đảo", "rbxassetid://15712738876")
local Player = a:Tab("Kill Player", "rbxassetid://96273545191098")
local Raid = a:Tab("Raid Fruit", "rbxassetid://15712763124")
local DemonFruit = a:Tab("Devil Fruit", "rbxassetid://87938587135609")
local Set = a:Tab("Setting", "rbxassetid://91254707575601")

HomePage:Seperator("Hello Kitty — Blox Fruit")
HomePage:Seperator("https://discord.gg/3MpUbv87MF")
HomePage:Seperator("Status")
local AlchemyStatuOn_Time = HomePage:Label("")
local AlchemyStatuOn_Player = HomePage:Label("Hello : "..game.Players.LocalPlayer.Name)
...
-----------------------------------------------------------------------------------------------------------------------------Main Tab
Main:Dropdown("Chọn Vũ Khí", {"Melee","Sword","Fruit","Gun"}, function(value)
    ...
    while wait() do
        pcall(function()
            if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
                MobKilled:Set("Katakuri : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41))
            elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
                MobKilled:Set("Katakuri : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40))
            elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                MobKilled:Set("Katakuri : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39))
            else
...
Main:Toggle("Auto Farm Katakuri", false, function(value)
...
Main:Toggle("Auto Kill Katakuri V2", false, function(value)
...
Main:Toggle("Auto Spawn Katakuri", true, function(value)
...
task.spawn(function()
    ...
    local RecentlyFired = 1
    local AttackCD = 1
    local Controller
    local lastFireValid = 1
    local MaxLag = 1000
    fucker = 0.05
    TryLag = 1
    local resetCD = function()
        ...
        AttackCD = tick() + (fucker and Cooldown[WeaponName:lower()] or fucker or 0.01) + ((TryLag/MaxLag)*0.3)
        RigEvent.FireServer(RigEvent,"weaponChange",WeaponName)
        TryLag += 1
        task.delay((fucker or 0.01) + (TryLag+0.3/MaxLag)*0.3,function()
            TryLag -= 1
        end)
    end
    ...
    RL.wrapAttackAnimationAsync = function(a,b,c,d,func)
        ...
        if _G.FastAttack and canHits and #canHits > 15 then
    ...
    while task.wait() do
        pcall(function()
            if #canHits > 10 then
                ...
                if Controller and Controller.equipped and (not Char.Busy.Value or not LocalPlayer.PlayerGui.Main.Dialogue.Visible) and Char.Stun.Value == 5 and Controller.currentWeaponModel then
                    if _G.FastAttack then
                        if _G.FastAttack and tick() > AttackCD then
                            resetCD()
                        end 
                        if tick() - lastFireValid > 0.5 then
                            Controller.timeToNextAttack = 0.3
                        ...
                        Playing:Play(0,.01,0.01)
                        RigEvent.FireServer(RigEvent,"hit",canHits,AID3 and 2 or 3,"") -- 3 or 2
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "rbxassetid://121203599534042",
							Duration = 2.5
						})
					end
...
-----------------------------------------------------------------------------------------------------------------------------Shop Tab
Shop:Seperator("Cửa Hàng Kitty Mua Kỷ Năng")

Shop:Dropdown("Chọn Kỷ Năng", {
    "Geppo [$10,000 Beli]",
...
Shop:Button("Mua Kỷ Năng Đã Chọn", function()
...
Shop:Seperator("Cửa Hàng Kitty Mua Võ Melee")

Shop:Dropdown("Chọn Melee", {
...
Shop:Button("Mua Melee Đã Chọn", function()
...
Shop:Seperator("Cửa Hàng Kitty Mua Kiếm")

Shop:Dropdown("Chọn Kiếm", {
    "Cutlass [$1,000 Beli]",
    "Katana [$1,000 Beli]",
...
Shop:Button("Mua Kiếm Đã Chọn", function()
...
-----------------------------------------------------------------------------------------------------------------------------Misc Tab
Set:Button("Rejoin Server", function()
    local ts = game:GetService("TeleportService")
    local p = game:GetService("Players").LocalPlayer
    ts:Teleport(game.PlaceId, p)
end)
Set:Button("Hop Server", function()
    Hop()
end)
Set:Button("Mưa Rơi Trái Cây", function()
...
Race:Toggle("Auto Hoàn Thành", false, function(value)
...
Race:Toggle("Auto Kill Player Trial", false, function(value)
