...
local HomePage = a:Tab("Home", "rbxassetid://96951468820217")
local Main = a:Tab("Main", "rbxassetid://15712703260")
local Farm = a:Tab("Farm", "rbxassetid://15712717270")
local Stats = a:Tab("Stats", "rbxassetid://76287763774607")
local Race = a:Tab("Race V4", "rbxassetid://15712776421")
local Event = a:Tab("Sea Event", "rbxassetid://115811927012077")
local Tele = a:Tab("Teleport", "rbxassetid://15712738876")
local Player = a:Tab("Player", "rbxassetid://96273545191098")
...
local Misc = a:Tab("Misc", "rbxassetid://115173753924486")
...
Main:Dropdown("Chế Độ Farm", {"Quest","No Quest"}, function(value)
    FarmMode = value
end)
...
Main:Dropdown("Chế Độ Farm", {"No Quest", "Quest", "Mastery"}, function(value)
    CakeFMode = value
end)
